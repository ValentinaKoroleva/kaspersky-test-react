...
class KSecurityCloud extends Component {

    render() {
        const kscSrc = require("../assets/security-cloud.png")
        ...
        const sizeInfo = 20
        const numberSrc = require("../assets/numberKSC.png")
            ...
            <Container className="offer" fluid>
                <Row style={{ backgroundColor: 'white' }}>
                    <Col>
                        <Row>
                            <Col xs={4}>
                                <img style={{ width: sizeKSC + "%", hight: sizeKSC + "%" }} src={kscSrc} alt="kis-logo" />
                            </Col>
                            <Col xs={8}>
                                <p style={{ fontWeight: 'bold', fontSize: 'larger', margin: '0' }}>Kaspersky</p>
                                <p style={{ fontWeight: 'bold', fontSize: 'large', margin: '0' }}>Security Cloud</p>
                        ...
                        <Row>
                            <Col span="2">
                                ...
                                <OverlayTrigger trigger="click" placement="right" overlay={popover}>
                                    <img style={{ verticalAlign: 'top!important', width: sizeInfo / 3 + "%", height: sizeInfo + "%" }} src={infoSrc} alt="info" />
                                </OverlayTrigger>
                            </Col>
                        </Row>
                    </Col>
